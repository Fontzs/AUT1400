...
bool crypto::RSASign(RSA* rsa, const unsigned char* Msg, size_t MsgLen, unsigned char** EncMsg,
                     size_t* MsgLenEnc) {
...
bool crypto::RSAVerifySignature(RSA* rsa, unsigned char* MsgHash, size_t MsgHashLen,
